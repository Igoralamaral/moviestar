            ...
            <div class="col-md-6 offset-md-1">
                ...
                <form id="edit-movie-form" action="<?= $BASE_URL ?>movie_process.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class=" form-group">
                        ...
                        <input type="text" class="form-control" id="trailer" name="trailer" placeholder="Insira o trailer do filme" value=" <?= $movie->trailer ?>">
                    </div>
                    <div class="form-group">
                        <label for="description">Descrição:</label>
                        <textarea name="description" id="description" rows="5" class="form-control" placeholder="Descreva o filme..." trailer><?= $movie->description ?></textarea>
                    </div>
                    <input type="submit" class="btn card-btn padding-btn" value="Editar Filme">
                </form>
            </div>
            <div class="col-md-3">
